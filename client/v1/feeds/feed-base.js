...
export default class FeedBase extends EventEmitter {
   constructor(session) {
      super(session)
    ...
    return (
       Promise.delay(delay)
          ...
          .catch(ParseError, function() {
             ...
             if (that.parseErrorsMultiplier > parameters.maxErrors) throw new RequestsLimitError()
